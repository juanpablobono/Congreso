var RegistrarNuevoVendedor = function() {

    return {
        //main function to initiate the module
        init: function() {
            
            urlRegistrarNuevo = "vendedores/nuevo.php";
            urlModificar = "vendedores/modificar.php";
            urlMostrarDatos = "vendedores/obtenerPorId.php";            
            ...
            mostrarDatosFormulario = function(data) {   
                ...
                if(_isPassword === "1"){
                    urlModificar = "vendedores/modificarContrasenia.php";
                    ...
                    $("#telefono").val("-------");
                    $("#telefono").closest(".control-group").hide();
