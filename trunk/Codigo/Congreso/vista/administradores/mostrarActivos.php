<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Administradores <small> Gestiona los Administradores desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-tasks"></i>Administradores</div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">																	
                                    ...
                                    if (in_array('NuevoAdministrador', $_SESSION['c_sesion_permisos'])) {
                                        ...
                                        <?php
                                    }if (in_array('ModificarAdministrador', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                    ...
                                    <?php						
                                    }if (in_array('EliminarAdministrador', $_SESSION['c_sesion_permisos'])) {
                                        ?>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verAdministradoresActivos.js"></script>
    <script type="text/javascript" src="../resources/js/scripts/tablas/panelTabla.js"></script>     
    <script>
        jQuery(document).ready(function() {
            App.init();
            verAdministradoresActivos.init();
            PanelTabla.init();
        });
    </script>
</body>
