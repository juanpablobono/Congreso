<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Tipos <small> Gestiona los Tipos de Veh&iacute;culos desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-tasks"></i>Tipos</div>
                                ...
                                <table class="table table-bordered table-advance" id="tabla" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-480">Tipo de Veh&iacuteculo Padre</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verCategorias.js"></script>
