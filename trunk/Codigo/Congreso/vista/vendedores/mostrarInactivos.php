<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Administradores <small> Gestiona los Vendedores desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verVendedoresInactivos.js"></script>
    <script type="text/javascript" src="../resources/js/scripts/tablas/panelTabla.js"></script>     
    <script>
        jQuery(document).ready(function() {
            App.init();
            verVendedoresInactivos.init();
            PanelTabla.init();
        });
    </script>
</body>
