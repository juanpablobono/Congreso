<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Vendedores <small> Gestiona los Vendedores desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-tasks"></i>Vendedores</div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">																	
                                    ...
                                    if (in_array('NuevoVendedor', $_SESSION['c_sesion_permisos'])) {
                                        ...
                                        <?php
                                    }if (in_array('ModificarVendedor', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                        ...
                                        <?php
                                    }if(in_array('ModificarPassword', $_SESSION['c_sesion_permisos'])){
                                    ?>									
                                    <button href="#modalModificar" data-toggle="modal" id="btnModificarPassword" class="btn yellow">
                                            Modificar Password <i class="icon-pencil"></i>
                                    </button>

                                    <?php						
                                    }if (in_array('EliminarVendedor', $_SESSION['c_sesion_permisos'])) {
                                        ?>
                                ...
                                <table class="table table-bordered table-advance" id="tabla" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-480">Tel&eacute;fono</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verVendedoresActivos.js"></script>
    <script type="text/javascript" src="../resources/js/scripts/tablas/panelTabla.js"></script>     
    <script>
        jQuery(document).ready(function() {
            App.init();
            verVendedoresActivos.init();
            PanelTabla.init();
        });
    </script>
</body>
