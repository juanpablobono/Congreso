<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Provincias <small> Gestiona las Provincias desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-globe"></i>Provincias</div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">																	
                                    ...
                                    if (in_array('NuevaProvincia', $_SESSION['c_sesion_permisos'])) {
                                        ...
                                        <?php
                                    }if (in_array('ModificarProvincia', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                        ...
                                        <?php
                                    }if (in_array('EliminarProvincia', $_SESSION['c_sesion_permisos'])) {
                                        ?>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verProvincias.js"></script>
