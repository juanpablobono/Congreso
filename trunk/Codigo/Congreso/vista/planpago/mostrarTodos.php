<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Planes de Pago <small> Gestiona los Planes de Pago desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-tasks"></i>Planes de Pago</div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">																	
                                    ...
                                    if (in_array('NuevoPlan', $_SESSION['c_sesion_permisos'])) {
                                        ...
                                        <?php
                                    }if (in_array('ModificarPlan', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                        ...
                                        <?php
                                    }if (in_array('EliminarPlan', $_SESSION['c_sesion_permisos'])) {
                                        ?>
                                ...
                                <table class="table table-bordered table-advance" id="tabla" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-480">Cuotas</th>
                                            <th class="hidden-480">Inter&eacute;s</th>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verPlanes.js"></script>
