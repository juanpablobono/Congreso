<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Modelos <small> Gestiona los Modelos de Veh&iacute;culos desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-tasks"></i>Modelos</div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">																	
                                    ...
                                    <?php
                                    if (in_array('nuevaModelo', $_SESSION['c_sesion_permisos'])) {
                                        ?>
                                        ...
                                        <?php
                                    }if (in_array('ModificarModelo', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                        ...
                                        <?php
                                    }if (in_array('EliminarModelo', $_SESSION['c_sesion_permisos'])) {
                                        ?>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verModelos.js"></script>
