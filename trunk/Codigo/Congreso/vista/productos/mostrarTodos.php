<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Vehículos <small> Gestiona los Vehículos desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-tasks"></i>Vehículos</div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">																	
                                    ...
                                    if (in_array('NuevoProducto', $_SESSION['c_sesion_permisos'])) {
                                        ...
                                        <?php
                                    }if (in_array('ImagenProductos', $_SESSION['c_sesion_permisos'])) {
                                        ?>
                                        <button href="javascript:;" data-toggle="modal" id="btnImagenes" class="btn yellow">
                                            Im&aacute;genes <i class="icon-picture"></i>
                                        </button>
                                        <?php
                                    }if (in_array('ModificarProducto', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                        ...
                                        <?php
                                    }if (in_array('EliminarProducto', $_SESSION['c_sesion_permisos'])) {
                                        ?>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verProductos.js"></script>
