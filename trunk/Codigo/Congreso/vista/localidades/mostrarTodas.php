<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Localidades <small> Gestiona las Locaidades desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-globe"></i>Localidades</div>
                                ...
                                <div class="table-toolbar">																	
                                    ...
                                    if (in_array('NuevaLocalidad', $_SESSION['c_sesion_permisos'])) {
                                        ...
                                        <button id="btnRegistrarNuevo" class="btn green">
                                            Registrar Nueva <i class="icon-plus"></i>
                                        </button>

                                        <?php
                                    }if (in_array('ModificarLocalidad', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                        ...
                                        <?php
                                    }if (in_array('EliminarLocalidad', $_SESSION['c_sesion_permisos'])) {
                                        ?>
                                    ...
                                    <div class="btn-group tooltips" data-placement="bottom" data-original-title="Todas / Seleccionadas">
                                        <div id="chkSeleccion" class="switch margin-top-10" data-on="info" data-off="info" data-on-label="<i class='icon-globe'></i>" data-off-label="<i class='icon-check'></i>">
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verLocalidades.js"></script>
