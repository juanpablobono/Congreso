<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Cuotas <small> Gestiona las Cuotas Vencidas desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-tasks"></i>Cuotas Vencidas</div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">																	
                                    ...
                                    <?php
                                    if (in_array('NuevaCuota', $_SESSION['c_sesion_permisos'])) {
                                        ?>
                                        <button id="btnRegistrarNuevo" class="btn green">
                                            Registrar Nuevo <i class="icon-plus"></i>
                                        </button>
                                        <?php
                                    }if (in_array('ModificarCuota', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                        ...
                                        <?php
                                    }if (in_array('EliminarVenta', $_SESSION['c_sesion_permisos'])) {
                                        ?>
                                    ...
                                    <button id="imprimir" class="btn green">
                                ...
                                <table class="table table-bordered table-advance" id="tabla" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-480">Fecha Vencimiento</th>
                                            <th class="hidden-480">Importe</th>
                                            <th class="hidden-480">Cliente</th>
                                            <th class="hidden-480">Patente Vehículo</th>
                                            <th class="hidden-480">Nombre Vehículo</th>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verCuotasImpagasVencidas.js"></script>
    <script type="text/javascript" src="../resources/js/scripts/tablas/panelTabla.js"></script>     
    <script>
        jQuery(document).ready(function() {
            App.init();
            VerCuotasImpagasVencidas.init();
            PanelTabla.init();

            $("#imprimir").click(function doPrint() {
