<html>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">						
                        ...
                        <h3 class="page-title">
                            Ventas <small> Gestiona las Ventas desde aquí </small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-tasks"></i>Ventas</div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">																	
                                    ...
                                    if (in_array('NuevaVenta', $_SESSION['c_sesion_permisos'])) {
                                        ...
                                        <?php
                                    }if (in_array('VerDetalle', $_SESSION['c_sesion_permisos'])) {
                                        ?>
                                        <button href="javascript:;" data-toggle="modal" id="btnVerDetalle" class="btn yellow">
                                            Ver Detalle <i class="icon-list"></i>
                                        </button>
                                        <?php
                                    }if (in_array('ModificarVenta', $_SESSION['c_sesion_permisos'])) {
                                        ?>									
                                ...
                                <table class="table table-bordered table-advance" id="tabla" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-480">Pantente</th>
                                            <th class="hidden-480">Veh&iacute;culo</th>
    ...
    <script type="text/javascript" src="../resources/js/scripts/tablas/verVentas.js"></script>
